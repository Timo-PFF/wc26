...
const I18N = {
  en: {
    ...
    ttGdErr: 'Total absolute error between your predicted goal difference and the actual one, summed over all scored games. Lower is better.',
  ...
  de: {
    ...
    ttGdErr: 'Gesamter absoluter Fehler zwischen deiner getippten Tordifferenz und der tatsächlichen, summiert über alle gewerteten Spiele. Niedriger ist besser.',
