...
const I18N = {
  en: {
    ...
    yourLeagues: 'Your leagues', noLeaguesHint: "You haven't joined a league in this tournament yet — join one below.",
  ...
  de: {
    ...
    yourLeagues: 'Deine Ligen', noLeaguesHint: 'Du bist in diesem Turnier noch keiner Liga beigetreten — tritt unten einer bei.',
